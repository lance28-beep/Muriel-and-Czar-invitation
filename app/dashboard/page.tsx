          ...
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-[#688277]/20">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-[#688277]/10 rounded-full mb-4">
                <Lock className="h-10 w-10 text-[#800A06]" />
              </div>
              <div className="text-xs tracking-[0.25em] uppercase font-[family-name:var(--font-crimson)] font-semibold text-[#800A06]/60 mb-2">Welcome 
              {siteConfig.couple.groomNickname} & {siteConfig.couple.brideNickname}</div>
              <h1 className="text-3xl font-[family-name:var(--font-crimson)] font-bold text-[#800A06] mb-2">
                Wedding Dashboard
              </h1>
              <p className="text-[#800A06]/60 font-sans text-sm">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#800A06] mb-2 font-sans">
                  Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-3 border border-[#688277]/20 focus:border-[#800A06] rounded-xl font-sans placeholder:text-[#800A06]/40 transition-all duration-300 focus:ring-2 focus:ring-[#800A06]/10 bg-white"
                  autoFocus
                />
              </div>

              {error && (
                <div className="bg-[#688277]/10 border border-[#800A06]/30 rounded-xl p-3 flex items-center gap-2">
                  <AlertCircle className="h-5 w-5 text-[#800A06]" />
                  <span className="text-[#800A06] font-semibold text-sm">{error}</span>
                </div>
              )}

              <Button
                type="submit"
                className="w-full bg-[#800A06] hover:bg-[#800A06]/90 text-[#F9F8F4] py-3 rounded-xl font-semibold transition-all duration-300"
              >
                Access Dashboard
              </Button>
            </form>
    ...
    <div className="min-h-screen bg-[#F9F8F4]">
      ...
      <div className="bg-white/80 backdrop-blur-sm shadow-sm border-b border-[#688277]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-[family-name:var(--font-crimson)] font-bold text-[#800A06]">Wedding Dashboard</h1>
              <p className="text-[#800A06]/60 text-sm font-sans">Manage your guest list and RSVPs</p>
            </div>
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-[#688277]/20 text-[#800A06] hover:bg-[#688277]/10"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-[#800A06]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#800A06]">{stats.totalGuests}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Total Guests</p>
            <p className="text-xs text-[#800A06]/50 font-sans mt-1">{stats.total} entries</p>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#126555]/20 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Attending</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#800A06]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <XCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#800A06]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#800A06]">{stats.notAttending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Not Attending</p>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#9F8650]/30 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Pending</p>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#9F8650]/30 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Requests</p>
          </div>
          ...
          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#126555]/20 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Entourage</p>
          </div>

          <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-[#800A06]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#800A06]">{principalSponsors.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#800A06]/70 font-sans">Principal Sponsors</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
            <button
              ...
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 ${
                activeTab === "guests"
                  ? "bg-[#800A06] text-[#F9F8F4] shadow-md"
                  : "text-[#800A06] hover:bg-[#688277]/10"
              }`}
            >
        ...
        <div className="bg-white/90 rounded-2xl p-6 shadow-sm border border-[#688277]/20 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
            <div className="flex-1 w-full">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#800A06]/40" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search guests by name or email..."
                  className="w-full pl-10 pr-4 py-2 border border-[#800A06]/20 focus:border-[#800A06] rounded-xl font-sans placeholder:text-[#800A06]/40 transition-all duration-300 focus:ring-2 focus:ring-[#800A06]/10 bg-white"
                />
              </div>
            </div>
            <Button
              ...
              className="bg-[#800A06] hover:bg-[#800A06]/90 text-[#F9F8F4] transition-all duration-300"
            >
          ...
          {error && (
            <div className="bg-[#688277]/10 border border-[#800A06]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <AlertCircle className="h-5 w-5 text-[#800A06]" />
              <span className="text-[#800A06] font-semibold text-sm">{error}</span>
            </div>
          )}
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-[#688277]/10">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Name</th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Email</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">RSVP</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                    <span className="flex items-center justify-center gap-1">
                      <Users className="h-4 w-4" />
                      Guests
                    </span>
                  </th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Message</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#688277]/20">
                {filteredGuests.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-[#800A06]/60 font-sans">
                      {isLoading ? (
                        <div className="flex items-center justify-center gap-2">
                          <RefreshCw className="h-5 w-5 animate-spin text-[#800A06]" />
                  ...
                  filteredGuests.map((guest, index) => (
                    <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                      <td className="px-6 py-4 font-medium text-[#800A06] font-sans">{guest.Name}</td>
                      <td className="px-6 py-4 text-[#800A06]/70 font-sans">
                      ...
                      <td className="px-6 py-4 text-center">
                        ...
                        {guest.RSVP === "No" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#800A06]/20 text-[#800A06] rounded-full text-sm font-semibold">
                        ...
                        {!guest.RSVP || guest.RSVP.trim() === "" ? (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#688277]/10 text-[#800A06]/70 rounded-full text-sm font-semibold">
                            Pending
                          </span>
                        ) : null}
                      </td>
                      ...
                      <td className="px-6 py-4 text-[#800A06]/70 font-sans max-w-xs truncate" title={guest.Message || ""}>
                        {guest.Message || "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 text-[#800A06] hover:bg-[#688277]/10 rounded-lg transition-colors"
                            title="Edit guest"
                          >
                ...
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Phone</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)] whitespace-nowrap">
                        <span className="flex items-center justify-center gap-1">
                          <Users className="h-4 w-4" />
                          Guests
                  ...
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredRequests.length === 0 ? (
                      ...
                      filteredRequests.map((request, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#800A06] font-sans">{request.Name}</td>
                          <td className="px-6 py-4 text-[#800A06]/70 font-sans">
                          ...
                          <td className="px-6 py-4 text-[#800A06]/70 font-sans max-w-xs truncate">
                            {request.Message || "-"}
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-[#800A06] hover:bg-[#800A06]/90 text-[#F9F8F4] rounded-lg transition-colors font-semibold text-sm flex items-center gap-2 shadow-sm hover:shadow-md"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Role Category</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Role Title</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Email</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredEntourage.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-[#800A06]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#800A06]" />
                      ...
                      filteredEntourage.map((member, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#800A06] font-sans">{member.Name}</td>
                          <td className="px-6 py-4 text-[#800A06]/70 font-sans">
                            {member.RoleCategory || "-"}
                          </td>
                          <td className="px-6 py-4 text-[#800A06]/70 font-sans">
            ...
            <div className="bg-white/90 rounded-2xl shadow-sm border border-[#688277]/20 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#688277]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Male Principal Sponsor</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Female Principal Sponsor</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#688277]/20">
                    {filteredPrincipalSponsors.length === 0 ? (
                      <tr>
                        <td colSpan={3} className="px-6 py-12 text-center text-[#800A06]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin text-[#800A06]" />
                      ...
                      filteredPrincipalSponsors.map((sponsor, index) => (
                        <tr key={index} className="hover:bg-[#688277]/10 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#800A06] font-sans">{sponsor.MalePrincipalSponsor}</td>
                          <td className="px-6 py-4 text-[#800A06]/70 font-sans">
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Add to Guest List</h3>
            <button
              onClick={onCancel}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#800A06]/70 hover:text-[#800A06]"
            >
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-base text-[#800A06] font-sans leading-relaxed">
          ...
          <div className="bg-[#126555]/5 rounded-xl p-4 mb-6 border border-[#126555]/20">
            <p className="text-sm font-semibold text-[#800A06] mb-2 font-sans">Request Details:</p>
            <div className="space-y-2 text-sm text-[#800A06]/80 font-sans">
          ...
          <p className="text-sm text-[#800A06]/70 mb-6 font-sans">
          ...
          <div className="flex gap-3">
            <Button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 bg-[#800A06] hover:bg-[#800A06]/90 text-[#F9F8F4] disabled:opacity-50"
            >
              {isLoading ? (
                <>
            ...
            <Button onClick={onCancel} variant="outline" className="px-6 border-[#800A06]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">{editing ? 'Edit Entourage Member' : 'Add New Entourage Member'}</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#800A06]/70 hover:text-[#800A06]"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#800A06] mb-2 font-sans">Name *</label>
              <input
                type="text"
                value={formData.Name}
                onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
                className="w-full px-4 py-2 border border-[#800A06]/20 focus:border-[#800A06] rounded-xl text-sm font-sans placeholder:text-[#800A06]/40 transition-all duration-300 focus:ring-2 focus:ring-[#800A06]/10 bg-white"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-[#800A06] mb-2 font-sans">Email</label>
              <input
                type="email"
          ...
          <div className="flex gap-3 mt-6">
            <Button
              onClick={onSave}
              disabled={isLoading}
              className="flex-1 bg-[#800A06] hover:bg-[#800A06]/90 text-[#F9F8F4]"
            >
              {isLoading ? (
                <>
                  <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#800A06]/20">Cancel</Button>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#800A06]/20" disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Add New Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#800A06]/70 hover:text-[#800A06]"
            >
        ...
        <div className="p-6">
          <p className="text-sm text-[#800A06]/70 mb-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <input
              ...
              value={formData.Name}
              onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
              className="w-full px-4 py-3 border border-[#800A06]/20 focus:border-[#800A06] rounded-xl text-sm font-sans placeholder:text-[#800A06]/40 transition-all duration-300 focus:ring-2 focus:ring-[#800A06]/10 bg-white"
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button onClick={onClose} variant="outline" className="px-6 border-[#800A06]/20">
              Cancel
            </Button>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-[#688277]/20 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-[#688277]/10 px-6 py-4 border-b border-[#688277]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">Edit Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#688277]/10 rounded-lg transition-colors text-[#800A06]/70 hover:text-[#800A06]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-[#800A06]/20 focus:border-[#800A06] rounded-xl text-sm font-sans bg-white transition-all duration-300 focus:ring-2 focus:ring-[#800A06]/10"
                required
              >
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-[#688277]/20">
        <div className="px-5 py-4 border-b border-[#688277]/20 bg-[#688277]/10 rounded-t-2xl">
          <h3 className="text-base sm:text-lg font-bold text-[#800A06] font-[family-name:var(--font-crimson)]">{title}</h3>
        </div>
        <div className="px-5 py-4 text-sm sm:text-base text-[#800A06]/80 font-sans">
          {message}
        </div>
        <div className="px-5 py-4 flex justify-end gap-2 border-t border-[#688277]/20">
          <button onClick={onCancel} className="px-4 py-2 text-sm rounded-lg border border-[#800A06]/20 text-[#800A06] hover:bg-[#688277]/10 transition-colors font-sans">Cancel</button>
          <button onClick={onConfirm} className="px-4 py-2 text-sm rounded-lg bg-[#800A06] text-[#F9F8F4] hover:bg-[#800A06]/90 transition-colors font-sans">Delete</button>
        </div>
      </div>
    </div>
  )
