    ...
    <Section id="details" className="relative py-16 sm:py-20 md:py-24 lg:py-28">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 mb-8 sm:mb-12 md:mb-16 space-y-6 sm:space-y-10 md:space-y-14">
        ...
        <div className="relative group">
          ...
          {/* Main card */}
          <div className="relative elegant-card rounded-xl sm:rounded-2xl overflow-hidden border border-[#434F39]/30 premium-shadow hover:border-[#434F39]/50 transition-all duration-300">
            {/* Venue Image */}
            ...
            <div className="p-3 sm:p-5 md:p-7 lg:p-9">
              ...
              <div className="text-center mb-5 sm:mb-8 md:mb-10">
                {/* Day name */}
                <p className="text-[10px] sm:text-xs md:text-sm font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] uppercase tracking-[0.2em] mb-2 sm:mb-3">
                  Friday
                </p>
                
                {/* Month - Script style */}
                <div className="mb-2 sm:mb-4">
                  <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-[family-name:var(--font-ephesis)] text-[#434F39] leading-none">
                    May
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-7">
                  <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-[family-name:var(--font-crimson)] font-normal text-[#434F39] leading-none elegant-text-shadow">
                    29
                  </p>
                  <div className="h-10 sm:h-12 md:h-16 lg:h-20 w-[2px] bg-gradient-to-b from-[#434F39] via-[#434F39] to-[#434F39]" />
                  <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-[family-name:var(--font-crimson)] font-light text-[#434F39] leading-none">
                    2026
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  <div className="h-[1px] w-8 sm:w-10 md:w-14 bg-gradient-to-r from-transparent via-[#434F39] to-[#434F39]" />
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#434F39] rounded-full" />
                  <div className="h-[1px] w-8 sm:w-10 md:w-14 bg-gradient-to-l from-transparent via-[#434F39] to-[#434F39]" />
                </div>

                {/* Time */}
                <p className="text-sm sm:text-base md:text-lg lg:text-xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] tracking-wide mb-4 sm:mb-6">
                  Ceremony: 3:00 PM
                </p>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] tracking-wide">
                  Reception: 3:00 PM
                </p>
              </div>

              {/* Location Details */}
              <div className="bg-gradient-to-br from-white/40 to-white rounded-xl p-3 sm:p-4 md:p-5 mb-4 sm:mb-6 border border-[#434F39]/20">
                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-[#434F39] mt-0.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                    <p className="text-xs sm:text-sm md:text-base font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] mb-1.5 sm:mb-2 uppercase tracking-wide">
                      Location
                    </p>
                    <p className="text-xs sm:text-sm md:text-base lg:text-lg font-[family-name:var(--font-crimson)] text-[#434F39] leading-relaxed">
                      {ceremonyVenueName}
                    </p>
                    {ceremonyVenueDetail && (
                      <p className="text-[10px] sm:text-xs md:text-sm font-[family-name:var(--font-crimson)] text-[#434F39]/70 leading-relaxed mt-1">
                        {ceremonyVenueDetail}
                      </p>
                    )}
                    <p className="text-[10px] sm:text-xs md:text-sm font-[family-name:var(--font-crimson)] text-[#434F39]/70 leading-relaxed">
                      {ceremonyAddress}
                    </p>
                  </div>
                  {/* QR Code for Ceremony - Right side */}
                  <div className="flex flex-col items-center gap-1.5 sm:gap-2 flex-shrink-0">
                    <div className="bg-white p-1.5 sm:p-2 md:p-2.5 rounded-lg border border-[#434F39]/20 shadow-sm">
                      <QRCodeSVG
                    ...
                    <p className="text-[9px] sm:text-[10px] md:text-xs font-[family-name:var(--font-crimson)] text-[#434F39]/60 italic text-center max-w-[80px]">
                      Scan for directions
                    </p>
                  </div>
                </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          ...
          <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-[family-name:var(--font-crimson)] font-normal text-[#85562A] mb-4 sm:mb-6 uppercase tracking-[0.1em] sm:tracking-[0.12em] elegant-text-shadow">
        ...
        <div className="relative group mb-8 sm:mb-10 md:mb-12">
          <div className="relative bg-white backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-7 md:p-9 border-2 border-[#434F39]/30 shadow-lg hover:shadow-xl transition-all duration-300">
            <h4 className="text-lg sm:text-xl md:text-2xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] mb-4 sm:mb-6 uppercase tracking-[0.12em] text-center">
              Color Palette for Guests & Sponsors
            </h4>
            <p className="text-base sm:text-lg md:text-xl font-[family-name:var(--font-crimson)] text-[#434F39] leading-relaxed text-center mb-6 sm:mb-8">
            ...
            <div className="flex justify-center gap-3 sm:gap-4 flex-wrap">
              <div className="flex flex-col items-center gap-2 sm:gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-medium text-[#434F39]">Rustic</span>
              </div>
              <div className="flex flex-col items-center gap-2 sm:gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-medium text-[#434F39]">Terracotta</span>
              </div>
              <div className="flex flex-col items-center gap-2 sm:gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-medium text-[#434F39]">Orange</span>
              </div>
              <div className="flex flex-col items-center gap-2 sm:gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-medium text-[#434F39]">Nude</span>
              </div>
              <div className="flex flex-col items-center gap-2 sm:gap-2.5">
                ...
                <span className="text-xs sm:text-sm font-[family-name:var(--font-crimson)] font-medium text-[#434F39]">Light Brown</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative group mb-8 sm:mb-10 md:mb-12">
          <div className="relative bg-white backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-7 md:p-9 border-2 border-[#434F39]/30 shadow-lg hover:shadow-xl transition-all duration-300">
            <h4 className="text-lg sm:text-xl md:text-2xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] mb-6 sm:mb-8 uppercase tracking-[0.12em] text-center">
              Dress Code Guide
            </h4>
            ...
            <div className="space-y-6 sm:space-y-8">
              {/* Principal Sponsors */}
              <div>
                <h5 className="text-base sm:text-lg md:text-xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] mb-3 sm:mb-4">
                  For Principal Sponsors:
                </h5>
                <div className="space-y-2 sm:space-y-3">
                  <p className="text-sm sm:text-base md:text-lg font-[family-name:var(--font-crimson)] text-[#434F39] leading-relaxed">
        ...
        <div className="relative group mt-10 sm:mt-14 md:mt-16">
          <div className="absolute -inset-1 bg-gradient-to-br from-[#434F39]/15 to-[#434F39]/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-lg" />
          
          <div className="relative bg-white backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-7 md:p-9 border-2 border-[#434F39]/30 shadow-lg hover:shadow-xl transition-all duration-300" style={{ backgroundColor: '#FFFFFF' }}>
            <h4 className="text-lg sm:text-xl md:text-2xl font-[family-name:var(--font-crimson)] font-semibold text-[#434F39] mb-6 sm:mb-7 md:mb-8 uppercase tracking-[0.12em] text-center">
              Important Reminders
            </h4>
            ...
            <div className="space-y-5 sm:space-y-6 md:space-y-7">
              {/* Attendance Limited */}
              <div className="bg-gradient-to-br from-white/30 via-white/20 to-white rounded-xl p-5 sm:p-6 md:p-7 border border-[#434F39]/20">
                <p className="text-sm sm:text-base md:text-lg font-[family-name:var(--font-crimson)] text-[#434F39] leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-white/30 via-white/20 to-white rounded-xl p-5 sm:p-6 md:p-7 border border-[#434F39]/20">
                <p className="text-sm sm:text-base md:text-lg font-[family-name:var(--font-crimson)] text-[#434F39] leading-relaxed">
                  <span className="font-semibold">Gift Policy:</span> Your presence is the greatest gift of all. But if you wish to bless us further, a monetary gift will help us start our new life together. Note: Money gifts can also be given in person.
                </p>
              </div>
            ...
            {/* Thank You Note */}
            <div className="mt-7 sm:mt-8 md:mt-9 pt-6 sm:pt-7 md:pt-8 border-t border-[#434F39]/20">
              <p className="text-sm sm:text-base md:text-lg font-[family-name:var(--font-crimson)] text-[#434F39] text-center leading-relaxed italic">
